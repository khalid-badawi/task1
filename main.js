      ...
      if (e.key === "Enter") {
        ...
        if (newTaskDescription !== "") {
          ...
          if (
            ...
            document.getElementById("pendingBtn").classList.contains("selected-btn")
          ) {
    ...
    filteredTasks.forEach((task, index) => {
        ...
        checkbox.addEventListener("change", function () {
            ...
            if (checkbox.checked) {
                ...
                if (!document.getElementById("allBtn").classList.contains("selected-btn")) {
                    filteredTasks = tasks.filter((task) => task.status === "pending");
                    renderTasks(filteredTasks);
                }
            } else {
        ...
        dragIcon.addEventListener("dragover", function (e) {
            e.preventDefault();
        });

        dragIcon.addEventListener("drop", function (e) {
            e.preventDefault();
